...
class AppConfig:
    ...
    def init_config(cls, filename: str) -> None:
        ...
        :param filename: El nombre del archivo de configuración (e.g. 'appconfig.toml')
        :type filename: str
        """
...
def structure_config(obj: AppConfig | DataSection, config: dict) -> None:
    ...
    :param obj: El objeto actual donde se establecerán los atributos.
    :type obj: AppConfig or DataSection
    :param config: El diccionario de configuración que se procesará.
    :type config: dict
    """
